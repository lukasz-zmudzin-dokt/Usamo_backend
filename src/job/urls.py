...
urlpatterns = [
    ...
    path('offer-interested/<uuid:offer_id>', views.JobOfferInterestedUsersView.as_view()),
    #job offers for employers
    path('employer/offer-interested/<uuid:offer_id>', views.EmployerJobOfferInterestedUsersView.as_view()),
