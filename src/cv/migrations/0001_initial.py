    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('year_end', models.PositiveIntegerField(default=2019, null=True, validators=[django.core.validators.MinValueValidator(1990), cv.models.max_value_current_year])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cv', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='basic_info', to='cv.CV')),
            ],
        ),
    ]
